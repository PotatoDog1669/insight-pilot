...
#   bash .codex/skills/insight-pilot/scripts/bootstrap_env.sh --upgrade
#   bash .codex/skills/insight-pilot/scripts/bootstrap_env.sh --check-only
#   bash .codex/skills/insight-pilot/scripts/bootstrap_env.sh --editable /path/to/insight-pilot
#
# Env vars:
